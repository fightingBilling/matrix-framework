...
import org.matrix.framework.core.platform.monitor.web.view.URLMapping;
import org.matrix.framework.core.platform.monitor.web.view.URLMappings;
...
@Controller
public class URLMappingController extends MatrixRestController {

    private RequestMappingHandlerMapping handlerMapping;

    @RequestMapping(value = "/monitor/mappings", method = RequestMethod.GET)
    @ResponseBody
    @Pass
    public URLMappings urlMappings(HttpServletRequest request) {
